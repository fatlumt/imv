# IMV Web Frontend (Step 8)

Responsive React + Vite scaffold that mirrors the existing PHP dashboard filters, exports, totals, and now routes create/edit forms through dedicated pages with shared auth state.
